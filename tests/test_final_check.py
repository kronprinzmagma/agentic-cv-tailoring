...
def test_translated_non_company_stations_are_recognised():
    """EN renderings of the two non-company stations (Eigenregie, Auszeit)
    must not read as dropped stations (observed 2026-09-19, FIFA run)."""
    from cv_tailor.final_check import validate_translation

    de = (
        "## Berufserfahrung\n\n"
        "### 2026–heute | Eigenregie – KI-Produktentwicklung\n- a\n\n"
        "### 2025 | Familiär bedingte Auszeit\n\n"
        "### 2023–2025 | HealthApp – Senior Product Owner\n- b\n"
    )
    en = (
        "## Professional Experience\n\n"
        "### 2026–present | Independent – AI Product Development\n- a\n\n"
        "### 2025 | Family-related Career Break\n\n"
        "### 2023–2025 | HealthApp – Senior Product Owner\n- b\n"
    )
    assert validate_translation(de, en).fatal == []
