...
ALLOWED_RUN_FILES = {
    ...
    "_coach_questions.md",
    "_factcheck_open_questions.md",
    "_profile_fit.md",
    "_redundancy.md",
    "_idiom.md",
    "_translation_check.md",
    "_pdf_overflow_de.md",
    "_pdf_overflow_en.md",
    "04_final_de.pdf",
    "04_final_en.pdf",
...
def _finish_pipeline(job_id: str, ctx: RunContext) -> None:
    ...
    STATE.update(job_id, stage="Seitenanzahl wird geprüft")
    run_page_trim_if_needed(ctx, progress_cb=lambda msg: STATE.update(job_id, stage=msg))
