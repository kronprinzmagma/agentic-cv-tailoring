...
- **Management Summary >170 Wörter** (Zielkorridor laut CLAUDE.md: 120–160)
...
#
# Summary bounds are DELIBERATELY wider than the prompt's target corridor
# (120–160): the prompt states the goal, this check is the hard-fail band.
# The gap is hysteresis — a 118-word summary should not cost a writer round.
# Not a sync error; if you tighten one side, decide about the other.
