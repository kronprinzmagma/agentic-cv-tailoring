...
IDIOM_PATTERNS: tuple[IdiomPattern, ...] = (
    ...
    # "working students" bleibt bewusst UNGEFLAGGT: Alex hat am 2026-08-31
    # abschliessend entschieden, dass die zwei MediaHoldingCo-Nachwuchskräfte
    # Werkstudent:innen sind — Teilzeit neben dem Studium, bezahlt, kleinere
    # Aufgaben. Weder "interns" noch "student assistants" (= studentische
    # Hilfskraft) trifft das. Das Pattern hat gegen diesen Entscheid gearbeitet
    # und die Frage bei jedem EN-Lauf neu aufgeworfen.
