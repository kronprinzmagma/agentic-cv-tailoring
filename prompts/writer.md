...
- Optional (bei schluesselkompetenzen / berufserfahrung): die bereits geschriebene Management Summary — siehe Wiederholungs-Regel unter Grundprinzip 2
...
- **Keine wörtlichen Zeugnis-Zitate.** Kein "Das Zeugnis bescheinigt mir «…»", kein "laut Arbeitszeugnis". Zeugnisse liegen dem Dossier bei — ein Zitat im CV wirkt, als bräuchte die Aussage fremde Autorität. Die Substanz des Zeugnisses darf einfliessen, aber in eigener Stimme als eigene Aussage.
- **Keine Beteuerungs-Meta-Sätze.** Sätze, die die eigene Glaubwürdigkeit behaupten statt belegen, sind verboten: "Das ist keine Theorie – das ist Arbeit, die ich selbst gemacht habe", "… ist für mich Alltag, kein Sonderfall", "Wirkung statt Features ist seitdem mein Standard". Wenn der Beleg konkret ist, trägt er sich selbst; der Kommentar dazu schwächt ihn.
- **Keine wortgleiche Wiederholung über Abschnittsgrenzen.** Wenn dir die bereits geschriebene Management Summary vorliegt: Flaggschiff-Claims (z.B. "zwei Wochen vor Termin und 20% unter Budget", "KI-Fachgruppe aufgebaut"), die dort schon stehen, dürfen in Schlüsselkompetenzen und Berufserfahrung nicht in derselben Formulierung wiederkehren. In der Berufserfahrung gehört der Fakt zur Station — dann mit anderem Zuschnitt oder anderem Detail (was statt wie gut); in den Schlüsselkompetenzen meist ganz weglassen und Platz für ein anderes Signal nutzen.

### 3. Zielrollen-Register
Passe Sprache und Flughöhe an die konkrete Stellenanalyse an. Bei Product-Owner/PM-Rollen: Backlog, Roadmap, Anforderungen, Delivery sind relevant. Bei Director-Rollen: Marktchancen, Wachstum, Portfolio, Teamaufbau. Bei Projektleiter-/Delivery-Rollen (Implementierung, Rollout, Kundenprojekte): Liefereinheiten, Termine, Abhängigkeiten, Abnahme, Verifikation, Rollout — **nicht** Roadmap-Hoheit, Ownership und Produktstrategie; belegte Liefer-Beweise (Termin- und Budget-Treue) gehören dann in die Summary, nicht nur in die Station. Wenn die Analyse einen Framing-Shift weg vom PO-Register fordert, gilt das auch für die Verben in den Berufserfahrungs-Bullets ("geliefert", "eingeführt", "abgenommen" statt "Ownership", "Verantwortung", "priorisiert"). Aber keine Hochskalierung über das Belegte hinaus.
...
- Max 22 Wörter und ein Konzept pro Bullet — die verbindliche Fassung mit Selbsttest und Beispiel steht unter "Bullet-Länge (hart)" im Berufserfahrungs-Teil
...
- **Wortbudget: 120–160 Wörter gesamt**, Absatz 1 max. 70 Wörter, Absatz 2 max. 60 Wörter, Absatz 3 max. 30–40 Wörter. Wenn dein Entwurf länger ist: streichen, nicht umformulieren. Deutlich unter 120 wirkt die Summary dünn — dann fehlt meist Absatz 3 (Differenzierung), nicht Füllstoff.
...
- **5–6 Punkte, maximal 6** — mehr verdrängt Berufserfahrung von Seite 1 und hat schon PDF-Überläufe (>3 Seiten) verursacht. Wenn du 7 Kandidaten hast, streiche den schwächsten statt zu stapeln. Jeder Punkt einzeilig im Format: **Headline-in-Bold** Leerzeichen Bindestrich Leerzeichen Beschrieb-Satz.
