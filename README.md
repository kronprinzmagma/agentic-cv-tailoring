...
requirements and the documented experience, the pipeline stops with a
structured gap report and asks whether to continue. This gate exists to
...
flowchart TD
    ...
    ProfileFit -- "gaps found" --> YOU2["③ You: decide whether\nto continue or stop"]
...
- **Deterministic quality gates — no LLM judgement for structural rules.**
  ...
  length check (22-word bullets, 140–160-word summaries), and factcheck
  parse structured validator results. LLM reviewer signals only trigger a
